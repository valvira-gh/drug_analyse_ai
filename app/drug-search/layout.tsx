...
const SearchLayout = ({
  ...
  return (
    <SearchProvider>
      ...
      >
        <aside className="bg-sky-300 w-full border flex items-center justify-evenly laptop:justify-start laptop:w-1/4 laptop:h-screen laptop:flex-col laptop:items-center">
          <Sidebar />
        </aside>
